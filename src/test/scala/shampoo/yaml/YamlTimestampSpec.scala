...
class YamlTimestampSpec extends YamlCollectionSpec:
  ...
  private def verify(yaml: YamlMapping): Unit =
    ...
    assertMappingError("foo", classOf[DateTimeException]) { yaml.read[LocalDateTime]("foo") }
    assertMappingError("foo", classOf[DateTimeException]) { yaml.read[OffsetDateTime]("foo") }
    assertMappingError("foo", classOf[DateTimeException]) { yaml.read[Instant]("foo") }

    assert(yaml("bar") == YamlString("1954-12-28T13:33:22"))
    assertMappingError("bar", classOf[DateTimeException]) { yaml.read[LocalDate]("bar") }
    assertMappingError("bar", classOf[DateTimeException]) { yaml.read[LocalDate]("bar") }
    assert(yaml.read[LocalDateTime]("bar") == LocalDateTime.parse("1954-12-28T13:33:22"))
    assertMappingError("bar", classOf[DateTimeException]) { yaml.read[OffsetDateTime]("bar") }
    assertMappingError("bar", classOf[DateTimeException]) { yaml.read[Instant]("bar") }

    assert(yaml("baz") == YamlString("1962-07-31T14:44:33+06:30"))
    assertMappingError("baz", classOf[DateTimeException]) { yaml.read[LocalDate]("baz") }
    assertMappingError("baz", classOf[DateTimeException]) { yaml.read[LocalDateTime]("baz") }
    assert(yaml.read[OffsetDateTime]("baz") == OffsetDateTime.parse("1962-07-31T14:44:33+06:30"))
    // Throws exception in Java 8 & 11; no exception in Java 17 & 21
    //assertMappingError(, classOf[DateTimeException]) { yaml.read[Instant]("baz") }

    assert(yaml("qux") == YamlString("1977-01-31T15:55:44Z"))
    assertMappingError("qux", classOf[DateTimeException]) { yaml.read[LocalDate]("qux") }
    assertMappingError("qux", classOf[DateTimeException]) { yaml.read[LocalDateTime]("qux") }
    ...
    assert(yaml.getSequence("quux")(0) == YamlString("1983-03-01"))
    assert(yaml.getSequence("quux").read[LocalDate](0) == LocalDate.parse("1983-03-01"))
    assertSequenceError(0, classOf[DateTimeException]) { yaml.getSequence("quux").read[LocalDateTime](0) }
    assertSequenceError(0, classOf[DateTimeException]) { yaml.getSequence("quux").read[OffsetDateTime](0) }
    assertSequenceError(0, classOf[DateTimeException]) { yaml.getSequence("quux").read[Instant](0) }

    assert(yaml.getSequence("quux")(1) == YamlString("1954-12-28T13:33:22"))
    assertSequenceError(1, classOf[DateTimeException]) { yaml.getSequence("quux").read[LocalDate](1) }
    assert(yaml.getSequence("quux").read[LocalDateTime](1) == LocalDateTime.parse("1954-12-28T13:33:22"))
    assertSequenceError(1, classOf[DateTimeException]) { yaml.getSequence("quux").read[OffsetDateTime](1) }
    assertSequenceError(1, classOf[DateTimeException]) { yaml.getSequence("quux").read[Instant](1) }

    assert(yaml.getSequence("quux")(2) == YamlString("1962-07-31T14:44:33+06:30"))
    assertSequenceError(2, classOf[DateTimeException]) { yaml.getSequence("quux").read[LocalDate](2) }
    assertSequenceError(2, classOf[DateTimeException]) { yaml.getSequence("quux").read[LocalDateTime](2) }
    assert(yaml.getSequence("quux").read[OffsetDateTime](2) == OffsetDateTime.parse("1962-07-31T14:44:33+06:30"))
    // Throws exception in Java 8 & 11; no exception in Java 17 & 21
    //assertSequenceError(, classOf[DateTimeException]) { yaml("quux").read[Instant](2) }

    assert(yaml.getSequence("quux")(3) == YamlString("1977-01-31T15:55:44Z"))
    assertSequenceError(3, classOf[DateTimeException]) { yaml.getSequence("quux").read[LocalDate](3) }
    assertSequenceError(3, classOf[DateTimeException]) { yaml.getSequence("quux").read[LocalDateTime](3) }
    assert(yaml.getSequence("quux").read[OffsetDateTime](3) == OffsetDateTime.parse("1977-01-31T15:55:44+00:00"))
    assert(yaml.getSequence("quux").read[Instant](3) == Instant.parse("1977-01-31T15:55:44Z"))
